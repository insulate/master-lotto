...
| `hanoi_normal` | ฮานอยปกติ | ทุกวัน             | 17:30      |
...
| 3 ตัวล่าง | `three_bottom` | 3 หลัก      | 456      | 1:150             |
...
```javascript
ticket.bet_type === 'three_bottom' && results.three_bottom.includes(ticket.number);
// อยู่ใน array ของ 3 ตัวล่าง
```
